      ...
      <table class="tablaPrincipal">
        ...
        <tbody>
          <tr v-for="l in lista" v-bind:key="l">
            ...
            <td class="uno">{{ l.nombre }}</td>
            <td class="uno">{{ l.direccion }}</td>
            <td class="uno">{{ l.edad }}</td>
            <td class="uno">
              <a
                id="idEditar"
                @click="editarPer(l.id, l.nombre, l.direccion, l.edad)"
                >Editar</a
              >
            </td>
            <td class="uno">
...
<script>
import { listaPersonas, eliminarPersona } from "@/js/ProcesarPersona";
...
export default {
  ...
  methods: {
    async mostrasLista() {
      this.lista = await listaPersonas();
