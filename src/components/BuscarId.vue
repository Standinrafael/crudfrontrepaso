      ...
      <table class="tablaPrincipal">
        <thead>
          <tr>
            ...
            <th class="uno" scope="col">Nombre</th>
            <th class="uno" scope="col">Direccion</th>
            <th class="uno" scope="col">Edad</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="uno">{{ lista.nombre }}</td>
            <td class="uno">{{ lista.direccion }}</td>
            <td class="uno">{{ lista.edad }}</td>
            <td class="uno">
              <a
                id="idEditar"
                @click="
                  editarPer(lista.id, lista.nombre, lista.direccion, lista.edad)
                "
                >Editar</a
              >
            </td>
...
<script>
import { eliminarPersona, buscarPersona } from "@/js/ProcesarPersona";
...
export default {
  ...
  methods: {
    async mostrarLista() {
      this.lista = await buscarPersona(this.id);
